...
![Version: 2.4.2](https://img.shields.io/badge/Version-2.4.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.6.2](https://img.shields.io/badge/AppVersion-0.6.2-informational?style=flat-square)
...
| image.repository | string | `"radar-base/radar-app-config/radar-app-config-frontend"` | Image repository |
...
| gatewayAPI.path | string | `"/appconfig"` | Path to match within the URL structure |
