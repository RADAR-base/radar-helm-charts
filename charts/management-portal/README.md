...
| identity_server.server_url | string | `"{{ .Values.advertised_protocol }}://{{ .Values.server_name }}/kratos"` | The publicly accessible server URL for the IDP; needed when deviating from http(s)://server_name/kratos |
...
| authserver.server_url | string | `"{{ .Values.advertised_protocol }}://{{ .Values.server_name }}/hydra"` | The publicly accessible server URL for the authserver; needed when deviating from http(s)://server_name/auth |
