...
![Version: 0.10.4](https://img.shields.io/badge/Version-0.10.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.4.7](https://img.shields.io/badge/AppVersion-2.4.7-informational?style=flat-square)
...
| gatewayAPI.path | string | `"/appserver"` | Path to match within the URL structure |
| gatewayAPI.filters | list | check values.yaml | Additional HTTPRoute filters (e.g. URLRewrite, RequestHeaderModifier) Strips the /appserver prefix before forwarding, equivalent to the ingress nginx.ingress.kubernetes.io/rewrite-target: /$1 annotation. |
