...
| cluster.cluster.initdb.secret.name | string | `"radar-cloudnative-postgresql-managementportal"` |  |
...
| cluster.cluster.roles[0].passwordSecret.name | string | `"radar-cloudnative-postgresql-managementportal"` |  |
...
| cluster.cluster.roles[1].passwordSecret.name | string | `"radar-cloudnative-postgresql-restsourceauthorizer"` |  |
...
| cluster.cluster.roles[2].passwordSecret.name | string | `"radar-cloudnative-postgresql-appconfig"` |  |
...
| cluster.cluster.roles[3].passwordSecret.name | string | `"radar-cloudnative-postgresql-kratos"` |  |
...
| cluster.cluster.roles[4].passwordSecret.name | string | `"radar-cloudnative-postgresql-hydra"` |  |
...
| cluster.cluster.roles[5].passwordSecret.name | string | `"radar-cloudnative-postgresql-appserver"` |  |
...
| cluster.cluster.roles[6].passwordSecret.name | string | `"radar-cloudnative-postgresql-uploadconnector"` |  |
