...
![Version: 0.1.4](https://img.shields.io/badge/Version-0.1.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.3.0](https://img.shields.io/badge/AppVersion-v1.3.0-informational?style=flat-square)
...
| kratos.pdb | object | `{"enabled":false,"spec":{"maxUnavailable":null,"minAvailable":1}}` | Pod Disruption Budget configuration (covers kratos deployment only, not courier) |
| kratos.pdb.enabled | bool | `false` | Enable Pod Disruption Budget |
| kratos.pdb.spec.minAvailable | int | `1` | Minimum number of pods that must be available during disruptions |
| kratos.pdb.spec.maxUnavailable | string | `nil` | Maximum number of pods that can be unavailable during disruptions |
| kratos.autoscaling | object | `{"enabled":false,"maxReplicas":5,"minReplicas":1,"targetCPU":{"averageUtilization":80,"type":"Utilization"},"targetMemory":{}}` | Horizontal Pod Autoscaler configuration |
| kratos.autoscaling.enabled | bool | `false` | Enable HPA |
| kratos.autoscaling.minReplicas | int | `1` | Minimum number of replicas |
| kratos.autoscaling.maxReplicas | int | `5` | Maximum number of replicas |
| kratos.autoscaling.targetCPU | object | `{"averageUtilization":80,"type":"Utilization"}` | Target CPU utilization percentage |
| kratos.autoscaling.targetMemory | object | `{}` | Target Memory utilization percentage |
