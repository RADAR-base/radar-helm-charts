...
| redis.url | string | `"redis://radar-redis-follower-headless:6379"` | The redis server URL. Redis is used to keep track of garmin backfill progress and any other key value properties. |
