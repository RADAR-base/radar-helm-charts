...
![Version: 0.6.1](https://img.shields.io/badge/Version-0.6.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.8.1](https://img.shields.io/badge/AppVersion-7.8.1-informational?style=flat-square)
...
| kafka.url | string | `"SASL_PLAINTEXT://radar-kafka-radar-kafka:9094"` | Kafka broker URLs |
...
| schemaRegistry.url | string | `"http://confluent-schema-registry:8081"` | Schema registry URL |
