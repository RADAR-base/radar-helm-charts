...
*/}}
{{- define "radar-upload-connect-backend.name" -}}
...
*/}}
{{- define "radar-upload-connect-backend.image" -}}
...
*/}}
{{- define "radar-upload-connect-backend.imagePullSecrets" -}}
...
*/}}
{{- define "radar-upload-connect-backend.fullname" -}}
